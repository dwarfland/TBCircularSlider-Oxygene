...
type
  ...
  public
    ...
    method beginTrackingWithTouch(touch: UITouch) withEvent(&event: UIEvent): Boolean; override;
    method continueTrackingWithTouch(touch: UITouch) withEvent(&event: UIEvent): Boolean; override;
...
begin
  ...
  if assigned(self) then begin
    ...
    //61103: Nougat: Internal error: Unknown type "x"
...
method TBCircularSlider.beginTrackingWithTouch(touch: UITouch) withEvent(&event: UIEvent): Boolean;
begin
  inherited;
...
method TBCircularSlider.continueTrackingWithTouch(touch: UITouch) withEvent(&event: UIEvent): Boolean;
begin
  inherited;
...
begin
  ...
  //61106: Nougat: Nougat: Internal error: Attempted to read or write protected memory. in CircularSlider project
...
begin
  ...
  //Message	1	(H11) Local variable "angleFromNorth.8.self" is assigned to but never read	Z:\Code\Nougat Tests\CircularSlider\TBCircularSlider.pas	233	23	CircularSlider
